...
import { useAddCategory, UseStatusCategory } from "@/hooks/UseFetch"
...
export function CategoriesContent() {
  ...
  const deleteCategory = UseStatusCategory()
  ...
  const handleDelete = async() => {
    ...
    // ✅ Usa la mutación ya creada
    await deleteCategory.mutateAsync(body)
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <DeleteCategory
        ...
        deleteTargetCategory={deleteTargetCategory}
        deleteTargetProductCount={deleteTargetProductCount}
